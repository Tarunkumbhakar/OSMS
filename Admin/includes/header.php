...
<nav class="navbar navbar-dark bg-danger
    ...
    <div class="container-fluid" style="margin-top:30px;">
        <div class="row"><!-- start row -->
            <nav class="col-sm-2 bg-light sidebar nav-pills py-5 d-print-none"><!-- start side Bar -->
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                        <a class="nav-link <?php if(PAGE=='sellreport'){ echo 'active' ;} ?>" href="sellreport.php"><i class="fas fa-table"></i>Sell Report</a>
                        </li>
